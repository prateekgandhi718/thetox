  ...
  return (
    <div className="flex flex-col py-10 px-20 gap-8 border-solid ">
      ...
      <Link to = "/summary" className="flex flex-col items-center bg-transparent border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          <img className="object-cover w-full rounded-b-full h-96 md:h-48 md:w-48 md:rounded-full p-2 ring-2 ring-gray-300" src={require("../Designs/TwitterImageLogo.png")} alt=""/>
      ...
      <Link to = "/summary" className="flex flex-col items-center bg-transparent border rounded-lg shadow-md md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
          <img className="object-cover w-full rounded-b-full h-96 md:h-48 md:w-48 md:rounded-full p-2 ring-2 ring-gray-300" src={require("../Designs/LinkdinImageLogo.png")} alt=""/>
          <div className="flex flex-col justify-between p-4 leading-normal">

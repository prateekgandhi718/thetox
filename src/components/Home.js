...
const Home = () => {
  return (
    ...
    <div className='flex flex-col items-center justify-center py-10 px-20 gap-8 border-2 border-indigo-600'>
      ...
      <h1 class="mb-4 text-4xl leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Regain <mark class="px-2 text-white bg-blue-600 rounded dark:bg-blue-500">control</mark> over your days</h1>
    </div>
